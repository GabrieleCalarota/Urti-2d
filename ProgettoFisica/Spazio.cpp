 ...
 void Spazio::urto_anelastico(Particella* p1,Particella* p2){
  ...
  void Spazio::urto_elastico(Particella* p1,Particella* p2){
    ...
    double v1f=v1_fittizio*cos(teta_1_f);
    ...
    double v2f=v1_fittizio*sin(teta_1_f);
   ...
   while ((temp1!=NULL)&&(!flag)){
     ...
     while ((temp2!=NULL)&&!flag){
       if (temp1->p->miss_collision(temp2->p)){
        ...
        cout<<"La particella "<<temp1->p->get_name()<<" di massa "<<setprecision(2)<<temp1->p->get_mass()<<" in posizione ( "<<setprecision(2)<<temp1->p->get_x()<<", "<<setprecision(2)<<temp1->p->get_y()<<") sta collidendo con la";
        cout<<" particella "<<temp2->p->get_name()<<" di massa "<<setprecision(2)<<temp2->p->get_mass()<<"\n";
        //choose_collision(temp1->p,temp2->p);      
        urto_elastico(temp1->p,temp2->p);
        print_statistics();
       }}
       temp2=temp2->next;} 
     temp1=temp1->next;}
